...
<head>
    ...
    <title>Tambah Produk - Administrator</title>
    <link href="https://cdn.jsdelivr.net/npm/daisyui@4.12.2/dist/full.min.css" rel="stylesheet" type="text/css" />
    <script src="https://cdn.tailwindcss.com"></script>
</head>

<body class="flex flex-row">
    <ul class="sticky top-0 menu bg-base-200 w-60 h-screen">
    ...
    <div class="py-5 px-10 w-max">
        ...
        <div class="flex items-center justify-between">
            <h3 class="font-semibold text-2xl">Tambah Produk</h3>
        ...
        <div class="container bg-gray-800 mt-5 p-5 rounded-md w-[500px]">
            <form action="store.php" method="post" enctype="multipart/form-data">
                <label class="form-control w-full">
                    ...
                    <input name="name" type="text" placeholder="Nama" class="input input-bordered" />
                </label>
                <label class="form-control w-full">
                    <div class="label"><span class="label-text">Harga</span></div>
                    <input name="price" type="text" placeholder="Harga" class="input input-bordered" />
                </label>
                <label class="form-control w-full">
